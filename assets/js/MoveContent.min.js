...
var Move = function() {
    ...
    class t {
        ...
        destroy() {
            ...
            this.element.moveContent = null,
            delete this.element.moveContent,
            this.element = null
        }
        ...
        resetGlare() {
            this.glare && (this.glareElement.style.transform = "rotate(240deg) translate(-80%, -80%)",
        ...
        update() {
            ...
            this.glare && (this.glareElement.style.transform = `rotate(${t.angle}deg) translate(-20%, -20%)`,
        ...
        prepareGlare() {
            ...
            Object.assign(this.glareElement.style, {
                ...
                transform: "rotate(280deg) translate(-20%, -20%)",
        ...
        static move(e, i) {
            ...
            e instanceof Array && e.forEach(e=>{
                "moveContent"in e || (e.moveContent = new t(e,i))
            }
            )
        }
    }
    return "undefined" != typeof document && (window.moveContent = t,
    t.move(document.querySelectorAll("[data-tilt]"))),
    t
}();
